            ...
            IThread_Bindings
        {
            ...
            private void Update_(global::App4.Thread obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update__threaditems(obj._threaditems, phase);
                    }
                }
            }
            private void Update__threaditems(global::App4.sources.ThreadItem obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update__threaditems_info(obj.info, phase);
                        this.Update__threaditems_imgUri(obj.imgUri, phase);
                        this.Update__threaditems_threadContent(obj.threadContent, phase);
                        this.Update__threaditems_title(obj.title, phase);
                        this.Update__threaditems_name(obj.name, phase);
                        this.Update__threaditems_idFormat(obj.idFormat, phase);
                    }
                }
            }
            private void Update__threaditems_info(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // Thread.xaml line 34
            ...
            private void Update__threaditems_imgUri(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // Thread.xaml line 36
            ...
            private void Update__threaditems_threadContent(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // Thread.xaml line 41
            ...
            private void Update__threaditems_title(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // Thread.xaml line 24
            ...
            private void Update__threaditems_name(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // Thread.xaml line 27
            ...
            private void Update__threaditems_idFormat(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // Thread.xaml line 30
